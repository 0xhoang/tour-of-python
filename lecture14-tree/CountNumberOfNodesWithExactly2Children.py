...
class Node:
    ...
    def countFullChildren(self):
        ...
        if self.left is not None:
            total += self.left.countFullChildren()

        if self.right is not None:
            total += self.right.countFullChildren()
...
class BST:
    ...
    def countFullChildren(self):
        ...
        return self.root.countFullChildren()
